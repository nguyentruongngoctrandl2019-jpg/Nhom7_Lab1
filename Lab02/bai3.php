...
class SinhVien {
    ...
    public function setHoTen($v)  { $this->hoTen = $v; }
 
    public function getGioiTinh()   { return $this->gioiTinh; }
    public function setGioiTinh($v) { $this->gioiTinh = $v; }
 
    public function getNgaySinh()   { return $this->ngaySinh; }
    public function setNgaySinh($v) { $this->ngaySinh = $v; }
 
    public function getDiemTB()   { return $this->diemTB; }
    public function setDiemTB($v) { $this->diemTB = $v; }
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .alert ul { margin-left: 1.2rem; margin-top: 0.35rem; }
        ...
        .stt { font-weight: 700; color: var(--muted); }
        ...
        .tag-nam  { background: #dbeafe; color: #1d4ed8; }
        .tag-nu   { background: #fce7f3; color: #be185d; }
        .tag-xs   { background: #fef3c7; color: #92400e; }
        .tag-gioi { background: #d1fae5; color: #065f46; }
        .tag-kha  { background: #dbeafe; color: #1e40af; }
        .tag-tb   { background: #e0e7ff; color: #3730a3; }
        .tag-yeu  { background: #fee2e2; color: #991b1b; }
 
        .diem-val { font-weight: 700; font-size: 1rem; }
    ...
    <div class="card">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="select-wrap">
                    <select id="gioiTinh" name="gioiTinh" required>
                        <option value="" disabled <?= empty($_POST['gioiTinh']) ? 'selected' : '' ?>>-- Chọn giới tính --</option>
            ...
            <div class="form-group">
                ...
                <input type="number" id="diemTB" name="diemTB"
                       step="0.01" min="0" max="10"
                       placeholder="0.00 – 10.00"
                       value="<?= htmlspecialchars($_POST['diemTB'] ?? '') ?>"
                       required>
            </div>
    ...
    <div class="card">
        ...
        <div class="table-header">
            ...
            <?php if (!empty($mangSinhVien)): ?>
                <form method="post" action=""
                      onsubmit="return confirm('Xóa toàn bộ danh sách?')">
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><span class="tag <?= $gtClass ?>"><?= htmlspecialchars($sv->getGioiTinh()) ?></span></td>
                            <td><?= $ns ?></td>
